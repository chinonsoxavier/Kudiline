...
const Header = () => {
  ...
  return (
      ...
      <div className="md:h-44.5 h-25 center fixed top-0  z-50 inset-0 px-4 w-full">
        <div className="w-full backdrop-blur-[1px] bg-[#151515] border-[#282828] border h-15 md:h-24.5 max-w-[1126px] rounded-[50px] top-2 flex items-center justify-between px-5">
